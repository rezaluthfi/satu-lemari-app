...
class _RentalRequestSheetState extends State<RentalRequestSheet> {
  ...
  Future<void> _selectDate(BuildContext context, bool isPickup) async {
    ...
    // Tentukan tanggal awal untuk date picker
    // Untuk tanggal kembali, tanggal awalnya adalah tanggal ambil
    ...
    if (pickedDate != null && mounted) {
      setState(() {
        if (isPickup) {
          ...
          // Jika tanggal ambil baru lebih lambat dari tanggal kembali yang sudah ada, reset tanggal kembali
          ...
          // --- VALIDASI SAAT MEMILIH TANGGAL KEMBALI ---
      ...
      // Panggil validate setelah tanggal diubah agar pesan error bisa langsung hilang/muncul
              ...
              onTap: () {
                if (_selectedPickupDate == null) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                        content:
                            Text('Harap pilih tanggal ambil terlebih dahulu.'),
